...
rem    and run aws configure --profile <profile_name (ie SLIP_SS_uat)> to configure the user profile. The other option is to manually create the credential file see. http://docs.aws.amazon.com/sdk-for-java/v1/developer-guide/credentials.html
set aws_profile="SLIP_SS_uat"
...
rem    Set the AWS S3 folder(Known as key) you would like to load your data too.
